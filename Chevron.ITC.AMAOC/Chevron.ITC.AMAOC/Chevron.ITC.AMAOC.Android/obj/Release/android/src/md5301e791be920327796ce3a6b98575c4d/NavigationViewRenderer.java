...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Chevron.ITC.AMAOC.Droid.NavigationViewRenderer, Chevron.ITC.AMAOC.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NavigationViewRenderer.class, __md_methods);
	}
	...
	public NavigationViewRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == NavigationViewRenderer.class)
			mono.android.TypeManager.Activate ("Chevron.ITC.AMAOC.Droid.NavigationViewRenderer, Chevron.ITC.AMAOC.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
