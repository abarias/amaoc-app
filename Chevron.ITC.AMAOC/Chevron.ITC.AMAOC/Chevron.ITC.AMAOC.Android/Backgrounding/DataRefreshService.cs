...
{
    [Service(Name = "com.Chevron.ITC.AMAOC.DataRefreshService", Exported = true, Permission = "com.google.android.gms.permission.BIND_NETWORK_TASK_SERVICE")]
        ...
        public static void ScheduleRefresh(Context context)
        {
            try
            {
                ...
                var pt = new PeriodicTask.Builder()
                    ...
                    .SetTag("com.Chevron.ITC.AMAOC.backgrounddatarefresh")
                    .SetPersisted(true)
